...
public interface WorkflowTransitionRepository extends JpaRepository<WorkflowTransitionEntity, Integer> {
    ...
    // uq_transition_from_action_role kisitiyla birebir eslesir - V12 migration.
    Optional<WorkflowTransitionEntity> findByFromStatusIdAndActionIdAndRoleId(
            Integer fromStatusId, Integer actionId, Integer roleId);
