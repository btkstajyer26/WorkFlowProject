...
class RecordSpecificationsTest {
    ...
    void theCreatorFilterOnlyNarrowsTheScope() {
        ...
        RecordSpecifications.withFilters(criteria, new btk.staj.WorkFlowProject.rbac.service.RecordAccessPolicy(actor -> java.util.Set.of(), (recordId, actorId) -> false).scopeFor(visibility(RoleName.CALISAN, USER_ID)))
    ...
    void refusesToBuildWithoutAnActor() {
        ...
        assertThatNullPointerException().isThrownBy(
                () -> RecordSpecifications.withFilters(null, new btk.staj.WorkFlowProject.rbac.service.RecordAccessPolicy(actor -> java.util.Set.of(), (recordId, actorId) -> false).scopeFor(visibility(RoleName.CALISAN, USER_ID))));
    }
    ...
    private void build(RoleName role) {
        Specification<Record> specification =
                RecordSpecifications.withFilters(new RecordSearchCriteria(), new btk.staj.WorkFlowProject.rbac.service.RecordAccessPolicy(actor -> java.util.Set.of(), (recordId, actorId) -> false).scopeFor(visibility(role, USER_ID)));
