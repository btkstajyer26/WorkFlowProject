...
export const mockRecords: WorkflowRecord[] = [
  {
    ...
    createdBy: 'John Doe',
    assignedTo: 'Başkan Yardımcısı', assignment: { kind: 'USER', userId: 'user-baskan-yardmcs', userFullName: 'Başkan Yardımcısı' },
  ...
  },
  {
    ...
    createdBy: 'John Doe',
    assignedTo: 'John Doe', assignment: { kind: 'USER', userId: 'user-john-doe', userFullName: 'John Doe' },
  ...
  },
  {
    ...
    createdBy: 'John Doe',
    assignedTo: 'Başkan', assignment: { kind: 'USER', userId: 'user-baskan', userFullName: 'Başkan' },
